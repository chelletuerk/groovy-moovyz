...
describe('MovieIndex', () => {
  ...
  it('should have a state of draftMessage that is an empty string', () => {
    const wrapper = shallow(<MovieIndex movies={fakeMovies} favorites={fakeArray} fetchData={fetchData} />)
  ...
  it.skip('should render a list of movies on load', () => {
    const wrapper = mount(<MovieIndex movies={fakeMovies} favorites={fakeArray} fetchData={fetchData} />);
